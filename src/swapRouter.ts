...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@ariswap/sdk-core'
...
import ISwapRouter from '@ariswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the Ariswap V3 SwapRouter, and has static methods for helping execute trades.
 */
